...
class PendaftaranShortMovieForm(ModelForm):
    class Meta:
        ...
        fields = ['Nama_Tim', 'Asal_Sekolah', 'Nama_Perwakilan', 'Nomor_Whatsapp_dan_Line', 'Nama_Anggota', 'Paham_dan_ingin_berpartisipasi', 'Bukti_Transaksi']
...
class PendaftaranPosterForm(ModelForm):
    class Meta:
        ...
        fields = ['Nama', 'Asal Sekolah',
                  'Nomor_Whatsapp_dan_Line', 'Paham_dan_ingin_berpartisipasi', 'Bukti_Transaksi',]
